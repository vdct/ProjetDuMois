...
UPDATE pdm_features_covid19 SET contrib='add_covid'
FROM contribs
WHERE pdm_features_covid19.contrib IS NULL AND pdm_features_covid19.osmid=contribs.osmid AND pdm_features_covid19.ts=contribs.ts AND contribs.prev AND contribs.curr;
